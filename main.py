...
def TakeImages():
    ...
    if ((name.isalpha()) or (' ' in name)):
        ...
        with open('StudentDetails\StudentDetails.csv', 'a+') as csvFile:
            ...
            writer.writerow(row)
        csvFile.close()
        sql = "insert into register(ID,Name,Email)values(%s, %s, %s)"
        val = (Id,name,email)
...
def TrackImages():
    ...
    while True:
        ...
        if (cv2.waitKey(1) == ord('q')):
            ...
            s = smtplib.SMTP('smtp.gmail.com', 587)
            s.starttls()
            s.login("nitesh.setti2001@gmail.com", "Nitesh965@settiphp")
            message = "Your attendence is Marked Successfully !!!"
            sqld="""SELECT Email from register where ID = %s"""
            db.mycursor.execute(sqld,(Id,))
            myresult = db.mycursor.fetchall()
            for x in myresult:
                for t in x:
                    print(t)
                    s.sendmail("nitesh.setti2001@gmail.com",t, message)
                    s.quit()
            break
    ts = time.time()
    date = datetime.datetime.fromtimestamp(ts).strftime('%d-%m-%Y')
...
lbl.place(x=80, y=55)
lb2 = tk.Label(frame1, text="Enter ID",width=20  ,height=1  ,fg="black"  ,bg="#00aeff" ,font=('times', 17, ' bold ') )
lb2.place(x=80, y=30)
txt = tk.Entry(frame2,width=32 ,fg="black",font=('times', 15, ' bold '))
txt.place(x=30, y=88)
txtx = tk.Entry(frame1,width=32 ,fg="black",font=('times', 15, ' bold '))
txtx.place(x=30, y=58)
...
lbl3 = tk.Label(frame2, text="Enter Email",width=20  ,fg="black"  ,bg="#00aeff" ,font=('times', 17, ' bold '))
...
message2 = tk.Label(frame2, text="1)Take Images  >>>  2)Save Profile" ,bg="#00aeff" ,fg="black"  ,width=39 ,height=1, activebackground = "yellow" ,font=('times', 15, ' bold '))
message2.place(x=7, y=290)
...
clearButton3.place(x=335, y=252)   
clearButton4 = tk.Button(frame1, text="Clear", command=clear4  ,fg="black"  ,bg="#ea2a2a"  ,width=11 , activebackground = "white" ,font=('times', 11, ' bold '))
clearButton4.place(x=335, y=57)    
